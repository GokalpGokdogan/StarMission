...
const PastMissions = () =>{
    return (
        <div className="p-4" style={{ width: '530px', height: '250px' }}>
            <ul className="flex-auto flex-col flex min-w-0 p-4 border rounded-xl border-transparent border-10 bg-grey-bg">
