...
import { getBidData, rejectIncomingBid, acceptIncomingBid, getImageById, getCompanyData, getMissionData} from '../../Requests';
...
const BidDetailsCompany = () => {
  ...
  const fetchMissionData = async () => {
    try{
        const mission = await getMissionData(bidData.mission_id);
        ...
        <div className="flex justify-center">
          <div className="flex flex-col justify-center" style={{ width: '1600px', minHeight: '250px' }}>
            <div className='flex-auto flex-col flex p-4 mb-10 ml-60 mr-60 mt-10 border rounded-xl border-transparent border-10 bg-white shadow-lg'>
              ...
              <h2 className="text-sm font-bold bg-bid-money p-1 w-64 border text-main-text ml-8">Current balance: ${missionData.budget}</h2>
