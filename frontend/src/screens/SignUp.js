...
const SignUp = () => {
    ...
    return (
        <div className="flex items-center justify-center bg-main-bg min-h-screen h-full">
                ...
                {isCompany ?
                    (<div><div className="sm:col-span-3 mt-4">
                        ...
                        <div className="flex items-center justify-center mb-4 mt-4">
                            <button type="submit" className={`w-32 bg-button-purple text-white transition-colors duration-300 ease-in-out hover:bg-indigo-700 hover:text-gray-100 hover:shadow-lg py-2 rounded-lg font-bold`} onClick={handleRegisterCompany}>
                                Sign Up
                            </button>
                        </div> </div>) :
                    (<div><div className="sm:col-span-3 mt-4">
